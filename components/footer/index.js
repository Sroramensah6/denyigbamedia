...
const styles = {
    ...
    subtitle: `font-mediumSerifItalic text-[1.4rem] text-[#292929] font-poppins`,
    ...
    return (
        <footer className="p-4 bg-[#0e2b19] border-y sm:p-6 sm:pb-4 mt-10 md:mt-0">
            <div className="md:flex md:justify-between">
                ...
                <div>
                <h2 className="mb-4 font-semibold text-[1rem] md:text-[1.4rem] lg:text-2xl uppercase text-[#F2F3F2] font-poppins ">
                    Teƒe veviawo
                        ...
                        <ul className="text-[#F2F3F2] space-y-4 font-poppins">
                            {main_link.slice(0, 3).map((link, index) => (
                                <li key={index}>
                                    <Link
                                        href={link.route}
                                        className={`${router.pathname === link.route ? 'bg-[#F2F3F2] text-[#0e2b19]' : 'text-[#F2F3F2] hover:bg-[#F2F3F2] hover:text-[#0e2b19]'} px-3 py-2 rounded-md text-xs font-medium font-poppins`}
                                    >
                                        {link.title}
                                    </Link>
                                </li>
